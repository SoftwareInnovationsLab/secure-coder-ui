...
function Exercise() {
  ...
  const handleGetHints = async () => {
    ...
    // }
    const b64 = Base64.encodeURI(JSON.stringify(exercise));

      // window.open(`${process.env.REACT_APP_AI_TUTOR_UI}`, "_blank");
    window.open(
        `${process.env.REACT_APP_AI_TUTOR_UI}/tutor?payload=${b64}`,
        "_blank"
      );
